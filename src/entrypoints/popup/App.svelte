<script lang="ts">
  ...
  const FALLBACK_MODELS: OpenRouterModel[] = [
    ...
    { id: "meta-llama/llama-3.3-70b-instruct", name: "Meta: Llama 3.3 70B", pricing: { prompt: "0.00000059", completion: "0.00000079" } },
    { id: "anthropic/claude-3-5-sonnet", name: "Anthropic: Claude 3.5 Sonnet", pricing: { prompt: "0.000003", completion: "0.000015" } },
  ];
  ...
  <header>
    <div class="logo-container">
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M7 10C7 10 9.5 7 12 7C14.5 7 17 10 17 10" stroke="#6b16ed" stroke-width="2" stroke-linecap="round" />
      ...
      <div class="setting-group">
        ...
        <div class="combobox" bind:this={comboboxEl} role="combobox">
          <input
            ...
            bind:this={inputEl}
          />
          <button class="combobox-toggle" onclick={toggleDropdown} tabindex="-1" aria-label="Toggle model list">
            <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M3 4.5L6 7.5L9 4.5" stroke="#737373" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </button>
